...
db_config = {
    "dbname": "databricks_2094",
    "user": "databricks_2094_user",
    "password": "KggDjPvWQZHiOrkWVMFO7ocyZwbs1AD8",
    "host": "dpg-cuokht5ds78s738lrhs0-a.oregon-postgres.render.com",
    "port": 5432,
}
...
def generate_transactions(transactions_per_day, customer_ids):
    ...
    high_transaction_days = {
        datetime(2025, 1, 5),
        datetime(2025, 1, 15),
    }  # Dias com mais transações
    high_transaction_customers = random.sample(
        customer_ids, 3
    ...
    while current_date <= end_date:
        daily_transactions = (
            ...
            if current_date in high_transaction_days
            else transactions_per_day
        )
        ...
        for _ in range(daily_transactions):
            ...
            customer_id = (
                random.choice(high_transaction_customers)
